...
<body id="page-top">
<!-- Header -->
<section class="masthead bg-primary text-white text-center" style="width:100%; height: 700px; position: relative; background: white !important;">
    <img class="img-fluid mb-5 d-block mx-auto" src="image/background.png" alt="" style="position: absolute; top:0;left:270px ; height: 770px; width:1000px; ">
    ...
    <div class="menu-list" style="top: 80px;">
        ...
        <a href="/culturalManage">
            <div style="width: 60px; height: 180px ;background: #cebeba ; position: absolute;top: 0;right: 0;">
                <img src="image/right-chevrons.png" style="width: 30px; height: 30px; position: absolute; top: 68px; left: 18px;" alt="">
            </div>
        </a>
    </div>
