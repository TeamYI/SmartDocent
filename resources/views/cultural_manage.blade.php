        ...
        <div class="nav_content" id="tab2">
            ...
            <div id="detail_icon" style="width: 100% ; height: 180px; font-size: 20px; font-weight: bold;border:1px solid black">
                ...
                <div id="detail_icon_box" style="padding:10px 10px ;height: 142px; border-top: 1px solid black; ">
                    <div>
                        <img src="/image/information.png" data-code='info.png' class="drag_image" >
                        <img src="/image/restroom.png" data-code='info.png' class="drag_image">
                    </div>
                    <div>
                        <img src="/image/qricon.png" class="drag_image">
                        <img src="/image/aricon.png" class="drag_image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="uk-modal-dialog explantion_size">
        ...
        <div class="uk-modal-header">
            ...
            <div class="uk-modal-body audio_content">
                <form action="{{URL::to('audioRegister') }}" method="post" enctype="multipart/form-data">
